        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="modal fade" id="tambahModal" tabindex="-1" role="dialog"
                    aria-labelledby="tambahModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content"
                            style="background: rgba(255, 255, 255, 0.5); backdrop-filter: blur(10px); box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 15px;">
                            <div class="modal-header">
                                <h5 class="modal-title poppins" id="tambahModalLabel">Tambah Foto</h5>
                            ...
                            <div class="modal-body" style="padding: 20px;">
                                <!-- Form tambah galeri -->
                                <form action="{{ route('mosque-gallery.store') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="title" class="poppins">Judul</label>
                                        <input type="text" class="form-control rounded" id="title" name="title"
                                            required>
                                    </div>
                                    {{-- <div class="form-group">
                                    <label for="description" class="poppins">Deskripsi</label>
                                    <textarea class="form-control rounded" id="description" name="description" rows="3"></textarea>
                                </div> --}}
                                    <div class="form-group">
                                        <label for="image" class="poppins">Gambar</label>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input rounded" id="image"
                                                name="image" accept="image/*" required>
                                            <label class="custom-file-label rounded" for="image">Pilih
                                                gambar...</label>
                                        </div>
                                    </div>

                                    <button type="submit" class="btn btn-primary rounded poppins"
                                        style="background-color: #4CAF50; border: none; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; border-radius: 5px;">Simpan</button>
                                </form>
                                <!-- Form tambah galeri -->
                            </div>
                        </div>
