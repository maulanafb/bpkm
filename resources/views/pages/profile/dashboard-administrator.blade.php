                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="POST"
                                    ...
                                    @if ($user != null)
                                        <img style="max-width: 300px" class="img-thumbnail img-fluid rounded"
                                    ...
                                    <div class="form-group">
                                        <label for="manager_status">Apakah Santri Penerima Amanah (S.P.A) Masjid Kapal
                                            Munzalan?</label>
                                        <select required data-show-subtext="true" data-live-search="true"
                                    ...
                                    <div class="form-group">
                                        <label for="other_position">Jabatan/amanah lainnya? (selain koordinator/PJ Masjid
                                            Kapal
                                            Munzalan Cabang)</label>
                                        <input type="text" name="other_position" class="form-control" id="other_position"
